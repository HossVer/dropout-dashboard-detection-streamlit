...
def load_dashboard():
    ...
    tableau_url = "https://public.tableau.com/views/JayaJayaInstituteDropoutAnalysis/DropoutParameterDashboard?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link"
